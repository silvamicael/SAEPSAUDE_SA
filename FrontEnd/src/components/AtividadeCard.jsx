    ...
    return (
        <div className="atividade-card">
            <div className="atividade-topo">
                ...
                <span className="atividade-data">18:30 - 12/08/24</span>
            </div>

            <div className="atividade-corpo">
                <img src={atividade.usuario.imagem} alt={atividade.usuario.nome} className="atividade-avatar" />
                <span className="atividade-usuario">{atividade.usuario.nome}</span>

                <div className="atividade-metricas">
                    <div><strong>{atividade.distancia / 1000} km</strong><span>Distância</span></div>
                ...
                <div className="atividade-interacoes">
                    <button className="botao-curtir">
                        <img src={atividade.jaCurtiu ? "/icons/CoracaoVermelho.svg" : "/icons/coracao.svg"} alt="Curtir" />
                        {atividade.curtidas}
                    </button>
